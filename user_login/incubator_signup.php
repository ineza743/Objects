...
if(isset($_POST['signup'])){
   ...
   if ( $FileSubmitted && $_POST['password']===$_POST['confirm_password']){
        $adding=adding_incubator($first_name,$last_name,$email,$address,$phone,$occupation,$business,$FileDestination,$details,$password);
    
        if($adding===true){
            header("Location:incubator_login.php");
        }
        else{
...
<div class="signup-form">
    <form action="" enctype="multipart/form-data" method="post">
        ...
        <div class="text-center">Already have an account? <a style="color:#e11584" href="incubator_login.php">Login</a></div>
    </form>
